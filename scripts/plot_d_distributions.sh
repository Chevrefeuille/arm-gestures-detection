...
plot '../data/pdfs/d_0.txt' with lines  ls 1  title "0", \
     '../data/pdfs/d_1.txt' with lines  ls 2  title "1", \
     '../data/pdfs/d_2.txt' with lines  ls 3  title "2", \
     '../data/pdfs/d_3.txt' with lines  ls 4  title "3", \
 
set key right top

set terminal pdf
set output '../results/d_pdfs_intensity.pdf'
replot 
set terminal x11
